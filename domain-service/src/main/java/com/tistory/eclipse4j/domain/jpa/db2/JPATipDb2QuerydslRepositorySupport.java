package com.tistory.eclipse4j.domain.jpa.db2;
...
@Repository
public abstract class JPATipDb2QuerydslRepositorySupport {
    ...
    public JPATipDb2QuerydslRepositorySupport(Class<?> domainClass) {
